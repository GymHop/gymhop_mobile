    ...
    <MapContainer>
      <BackgroundImageStyle
        ...
        <Container behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          ...
          />
          <GymIconContainer>
            <GymIcon tier={'premium'} logo_url={'https://res.cloudinary.com/gymhop/image/upload/v1628618717/Gym%20Photos/Bodybuilding-and-gym-logo-on-transparent-background-PNG_2_guwzmi.png'} />
          </GymIconContainer>
          <GymTileContainer>
            <GymTile
              main_photo_url={'https://res.cloudinary.com/gymhop/image/upload/v1628618091/Gym%20Photos/planetlift_k2jybr.png'}
              tier={'premium'}
