        ...
        <View style={styles.box}>
          ...
          <View style={styles.container}>
            <Row style={{justifyContent: 'space-between', marginTop: -5}}>
              <View>
                <Text style={styles.titleBold}>Premium</Text>
              </View>
              <View>
                <Text style={styles.priceFont}>$140</Text>
            ...
            <View>
              <Row style={{marginTop: 15}}>
                ...
                <Text style={styles.text}>
                  Unlimited access to all Premium{'\n'} and Standard Tier
                  partner{'\n'} locations
                </Text>
              </Row>
              <Row style={{marginTop: 15}}>
                ...
                />
                <Text style={styles.text}>
                  Diverse facilities with luxury{'\n'} amenities and classes
                </Text>
              </Row>
              <Row style={{marginTop: 15}}>
                <Image
          ...
          <TouchableOpacity>
            <LinearGradient
              ...
              style={styles.button}>
              <Text style={styles.buttonFont}>Subscribe</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </View>
